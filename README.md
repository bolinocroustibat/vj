...
This branch is using Django, [Django Shinobi](https://github.com/pmdevita/django-shinobi) and PostgreSQL. There is also a deprecated [branch using FastAPI and SQlite](https://github.com/bolinocroustibat/vj/tree/fastapi).
